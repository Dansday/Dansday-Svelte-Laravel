...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ url('/') }}/admin/articles/posts" class="css3animate btn btn-primary text-white">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($gallery_images as $gallery_image)
                                        <tr>
                                            <th scope="row">{{ $i++ }}</th>
                                            <td>
                                                <a href="{{ upload_url($gallery_image->image) }}" class="css3animate popup-content popup-image text-center text-gray-800 d-flex justify-content-between align-items-center popup-image-big">
                                                    <img src="{{ upload_url($gallery_image->image) }}" class="img-fluid img-size-200" />
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <form class="d-inline-block" action="{{url('/admin/articles/gallery')}}/{{ $gallery_image->id }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body text-center">
                                                                        ...
                                                                        <input type="hidden" name="post_id" value="{{ $gallery_image->article_id }}"/>
                                                                    </div>
