...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ url('/') }}/admin/projects/projects" class="css3animate btn btn-primary text-white">
...
<a href="{{ upload_url($gallery_image->image) }}" class="css3animate popup-content popup-image text-center text-gray-800 d-flex justify-content-between align-items-center popup-image-big">
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <form class="d-inline-block" action="{{url('/admin/projects/gallery')}}/{{ $gallery_image->id }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
