            ...
            [
                ...
                'inputSchema' => [
                    ...
                    'properties' => [
                        ...
                        'image'       => ['type' => 'string', 'description' => 'Optional cover image: an absolute URL, or a path returned by POST /mcp/uploads with kind=article. Omit for no image.'],
            ...
            [
                ...
                'inputSchema' => [
                    ...
                    'properties' => [
                        ...
                        'image'       => ['type' => 'string', 'description' => 'New cover image: an absolute URL, or a path returned by POST /mcp/uploads with kind=article. Pass an empty string to remove the image.'],
