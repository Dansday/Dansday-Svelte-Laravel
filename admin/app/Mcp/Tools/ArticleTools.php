            ...
            [
                ...
                'inputSchema' => [
                    ...
                    'properties' => [
                        ...
                        'created_at'  => ['type' => 'string', 'description' => 'Publication date, YYYY-MM-DD or YYYY-MM-DD HH:MM:SS. Defaults to now.'],
                    ],
            ...
            [
                ...
                'inputSchema' => [
                    ...
                    'properties' => [
                        ...
                        'created_at'  => ['type' => 'string', 'description' => 'New publication date, YYYY-MM-DD or YYYY-MM-DD HH:MM:SS.'],
                    ],
                    'required' => ['id'],
                ],
