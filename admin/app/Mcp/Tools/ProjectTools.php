            ...
            [
                ...
                'inputSchema' => [
                    ...
                    'properties' => [
                        ...
                        'image'       => ['type' => 'string', 'description' => 'Optional cover image: an absolute URL, or a path returned by POST /mcp/uploads with kind=project. Omit for no image.'],
            ...
            [
                ...
                'inputSchema' => [
                    ...
                    'properties' => [
                        ...
                        'image'       => ['type' => 'string', 'description' => 'New cover image: an absolute URL, or a path returned by POST /mcp/uploads with kind=project. Pass an empty string to remove the image.'],
