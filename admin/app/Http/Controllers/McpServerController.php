    ...
    private function initialize(array $params): array
    {
        ...
        return [
            ...
            'instructions' => implode(' ', [
                ...
                'To add an image, POST it as multipart form-data to /mcp/uploads with the same bearer token',
                'and a kind of article, project or inline; the response path goes in the image field,',
                'or into an img src for inline body images. Tool calls cannot carry binary themselves.',
